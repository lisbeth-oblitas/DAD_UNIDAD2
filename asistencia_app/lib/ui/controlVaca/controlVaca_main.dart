...
import 'package:asistencia_app/ui/controlVaca/MyAppState.dart';
...
import 'package:asistencia_app/ui/controlVaca/controlVaca_edit.dart';
import 'package:asistencia_app/ui/controlVaca/controlVaca_form.dart';
...
class MainControlVaca extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    /*return Provider<ControlVacaApi>(
      create: (_) => ControlVacaApi.create(),
      child: MaterialApp(
    ...
    return MultiProvider(
      providers: [
        Provider<ControlVacaApi>(create: (_) => ControlVacaApi.create(),),
...
class ControlVacaUI extends StatefulWidget {
  @override
  _ControlVacaUIState createState() => _ControlVacaUIState();
}

class _ControlVacaUIState extends State<ControlVacaUI> {
  //ApiCovid apiService;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ControlVacaForm()),
                  ).then(onGoBack);
                },
        ...
        body: FutureBuilder<List<ControlVacaModelo>>(
          future: Provider.of<ControlVacaApi>(context, listen: true)
              .getControlVaca(TokenUtil.TOKEN).then((value) => value),
          builder: (BuildContext context,
              AsyncSnapshot<List<ControlVacaModelo>> snapshot) {
            if (snapshot.hasError) {
              ...
              List<ControlVacaModelo> persona = snapshot.data!!;
  ...
  Widget _buildListView(BuildContext context, List<ControlVacaModelo> persona) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 8.0),
      child: ListView.builder(
        itemBuilder: (context, index) {
          ControlVacaModelo personax = persona[index];
          return Padding(
                  ...
                  children: <Widget>[
                    ListTile(
                        ...
                        title: Row(
                          children: [
                            Container(
                              child: Text(personax.etapaDetalle,
                                    ...
                                    Expanded(child: IconButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => ControlVacaFormEdit(
                                                    modelA: personax)),
                                          ).then(onGoBack);
                                        })),
                                    Expanded(child: IconButton(
                                        ...
                                        onPressed: () {
                                          showDialog(
                                            ...
                                            if (value.toString() == "Success") {
                                              print(personax.id);
                                              Provider.of<ControlVacaApi>(context,
                                                  listen: false)
                                                  .deleteControlVaca(TokenUtil.TOKEN,personax.id)
  ...
  void exportAsistenciaToExcel(List<AsistenciapaxModelo> asistencia) {
    ...
    for (var row = 0; row < asistencia.length; row++) {
      ...
      sheetObject
          ...
          .value = asistenciax.controlVaca.nombreControlVaca;
      sheetObject
